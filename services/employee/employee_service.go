...
func FindAllEmployeesWithCtx(repository repositories.EmployeeRepository, ctx *context.Context) dtos.Response {
...
func FindAllEmployeesPaging(repository repositories.EmployeeRepository, page int, limit int, offset int, sort string, searchs []dtos.Search) dtos.ResponsePaging {
